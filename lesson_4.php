                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="d-flex mt-2">
                                <?php echo $item['title'];?>
                                <span class="d-inline-block ml-auto"><?php $item['value'];?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="progress-bar <?php $item['bg'];?>" role="progressbar" style="width: <?php $item['width'];?>;" aria-valuenow="<?php $item['valuenow'];?>"" aria-valuemin="<?php $item['valuemin'];?>" aria-valuemax="<?php $item['valuemax'];?>"></div>
                            </div>
                            <?php endforeach;?>
                            <!-- <div class="d-flex">
                                Transfered
                            ...
                            <div class="d-flex">
                                User Testing
                                <span class="d-inline-block ml-auto">User Testing</span>
                            </div>
